<header class="w-full bg-fundoescuro">
    <nav class="flex items-center justify-between w-full p-5 font-bold font-poppins">
        <h1 class="text-azul1"><a href="{{route('home.index')}}">DriveNow</a></h1>
        <div class="dropdown dropdown-end">
            <div tabindex="0" role="button" class="ml-10 font-bold text-azul1 btn bg-slate-800">Menu</div>
            <ul tabindex="0"
                ...
                <li><a href="{{route('dashboard') }}">Meus veiculos</a></li>
